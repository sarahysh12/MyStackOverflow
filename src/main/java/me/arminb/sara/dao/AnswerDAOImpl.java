    ...
    public Answer save(Answer answer) throws DataAccessException {
        try {
            ...
            if (answer.getId() == null) {
                ...
                newDocument.append("$set", new BasicDBObject().append("answers.$.answer", answer.getAnswer())
                        .append("answers.$.rate", answer.getRate()).append("answers.$.modified_at", answer.getModifiedAt()));
